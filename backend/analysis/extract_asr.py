...
def process_video_with_scenes(video_file, scenes_folder, output_dir):
    ...
    scenes_file = os.path.join(scenes_folder, f"{base_filename}.txt")
    ...
    print(f"(ASR) {os.path.abspath(output_dir)}\n")
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        ...
        scenes_folder = os.path.join("../output", "timestamp")
        output_dir = os.path.join("../output", "asr")
